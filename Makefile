...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Tue Nov 30 18:21:02 2010
# Project:  guiEva.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/guiEva1.0.0/ && $(COPY_FILE) --parents bookmark.h debug.h globalfunctions.h insertpagerange.h MyWidget.h openpdf.h page.h pdfgui.h rotatepagerange.h TabPage.h tree.h .tmp/guiEva1.0.0/ && $(COPY_FILE) --parents pdfgui.qrc .tmp/guiEva1.0.0/ && $(COPY_FILE) --parents globalfunctions.cpp insertpagerange.cpp main.cpp MyWidget.cpp openpdf.cpp page.cpp pdfgui.cpp rotatepagerange.cpp TabPage.cpp .tmp/guiEva1.0.0/ && $(COPY_FILE) --parents insertpagerange.ui OpenPdf.ui page.ui pdfgui.ui rotatepagerange.ui showPage.ui .tmp/guiEva1.0.0/ && (cd `dirname .tmp/guiEva1.0.0` && $(TAR) guiEva1.0.0.tar guiEva1.0.0 && $(COMPRESS) guiEva1.0.0.tar) && $(MOVE) `dirname .tmp/guiEva1.0.0`/guiEva1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/guiEva1.0.0

...
# Generated by qmake (2.01a) (Qt 4.7.0) on: Mon Nov 29 23:31:38 2010
# Project:  trunk.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/trunk1.0.0/ && $(COPY_FILE) --parents bookmark.h debug.h globalfunctions.h insertpagerange.h MyWidget.h openpdf.h page.h pdfgui.h rotatepagerange.h TabPage.h tree.h .tmp/trunk1.0.0/ && $(COPY_FILE) --parents pdfgui.qrc .tmp/trunk1.0.0/ && $(COPY_FILE) --parents globalfunctions.cpp insertpagerange.cpp main.cpp MyWidget.cpp openpdf.cpp page.cpp pdfgui.cpp rotatepagerange.cpp TabPage.cpp .tmp/trunk1.0.0/ && $(COPY_FILE) --parents insertpagerange.ui OpenPdf.ui page.ui pdfgui.ui rotatepagerange.ui showPage.ui .tmp/trunk1.0.0/ && (cd `dirname .tmp/trunk1.0.0` && $(TAR) trunk1.0.0.tar trunk1.0.0 && $(COMPRESS) trunk1.0.0.tar) && $(MOVE) `dirname .tmp/trunk1.0.0`/trunk1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/trunk1.0.0
